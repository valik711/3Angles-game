...
class Triangle{
private:
    std::vector<int> cells = {30, 130, 120, 220, 210, 310, 300, 131, 231, 221, 321, 311, 232, 332, 322, 333}; // значения существующих координат для треугольников
    std::vector<int> noInverseCells = {30, 120, 210, 300, 131, 221, 311, 232, 322, 333};
// значения неиверсных координат для треугольников
    int points;
    int rotation;
    int x;
    int y;
